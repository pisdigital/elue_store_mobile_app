import 'package:elue_store/features/authentication/screens/store_selection/store_selection.dart';
import 'package:elue_store/features/shop/controllers/product/cart_controller.dart';
import 'package:elue_store/features/shop/screens/cart/cart.dart';
import 'package:elue_store/features/shop/screens/checkout/checkout.dart';
...
class AuthenticationRepository extends GetxController {
  ...
  //     //TODO: read local storage for SELECTED STORE if it exists skip to home else go to store selection page
  //       deviceStorage.read('selectedStore') != null ? Get.offAll(()=>const HomeMenu()) : Get.offAll(()=>const StoreSelection());
  ...
  screenRedirect(User? user) async {
    ...
    if (deviceStorage.read('isFirstTime') == null) {
      deviceStorage.writeIfNull('isFirstTime', true);
      if (deviceStorage.read('selectedStore') == null) {
        Get.offAll(() => StoreSelection());
      } else {
        Get.offAll(() => const HomeMenu());
      }
    ...
    // }
      ...
      deviceStorage.read('selectedStore') != null
          ? Get.offAll(() => const HomeMenu())
          : Get.offAll(() => StoreSelection());
    }
  }
