import 'dart:convert';
import 'dart:io';
import 'package:elue_store/features/personalization/models/user_profile_model.dart';
...
class UserRepository extends GetxController {
  ...
  Future<void> createUserProfile(dynamic user) async {
    try {
      ...
      final response = await THttpHelper.post('user-profile/', data.toJson());
