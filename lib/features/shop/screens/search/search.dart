import 'package:elue_store/common/widgets/images/t_circular_image.dart';
import 'package:elue_store/common/widgets/products/product_cards/product_card_vertical.dart';
import 'package:elue_store/common/widgets/products/product_cards/product_card_vertical_search_result.dart';
import 'package:elue_store/common/widgets/shimmers/category_shimmer.dart';
import 'package:elue_store/common/widgets/shimmers/search_category_shimmer.dart';
import 'package:elue_store/features/shop/controllers/brand_controller.dart';
...
import 'package:elue_store/features/shop/screens/brand/brand.dart';
...
class SearchScreen extends StatelessWidget {
                ...
                () => searchController.isLoading.value
                    ...
                    searchController.searchResults.isNotEmpty
                        ? TGridLayout(
                            ...
                            itemBuilder: (_, index) =>
                                ProductCardVerticalSearchResult(
                                    product:
  ...
  Widget _buildCategoryTile(CategoryModel category) {
    return Obx(() => _buildParentCategoryTile(category));
  }
  ...
  List<Widget> _buildSubCategories(String parentId) {
    List<SubCategoryModel> subCategories = categoryController.allSubCategories
  ...
  Widget _buildSubCategoryTile(SubCategoryModel subCategory) {
