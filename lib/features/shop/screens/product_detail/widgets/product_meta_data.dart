      ...
      children: [
        ...
        Row(
          children: [
            ...
            if ((product.productVariations == null || product.productVariations!.isEmpty) && product.salePrice> 0.0 && product.salePrice != product.price)
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
            ...
            TProductPriceText(price: controller.getProductPrice(product), isLarge: true, currencySign: StoreSelectionController.instance.getCurrency(),),
