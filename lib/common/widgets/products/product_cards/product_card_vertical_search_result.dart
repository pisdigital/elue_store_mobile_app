...
class ProductCardVerticalSearchResult extends StatelessWidget {
  const ProductCardVerticalSearchResult(
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () async {
        ProductModel result =
            await productController.fetchProductById(product.id);
        if (result.id != '') {
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  TProductTitleText(title: product.title, smallSize: false),
                  // const SizedBox(height: TSizes.spaceBtwItems / 2),
